...
public class CidadeDAO implements GenericDAO{
    ...
    public Boolean inserir(Object objeto) {
        ...
        try{
            ...
            stmt.setInt(2, oCidade.getEstado().getIdEstado());//Utilização da agregação
            ...
            try{
                System.out.println("Problemas ao cadastrar a Cidade! Erros: "+ex.getMessage());
                ex.printStackTrace();
                conexao.rollback();
    ...
    public Boolean alterar(Object objeto) {
        ...
        try {
            ...
            try {
                System.out.println("Problemas ao alterar a Cidade! Erros: "+ex.getMessage());
                ex.printStackTrace();
                conexao.rollback();
            } catch (SQLException e){
                System.out.println("Erro:"+e.getMessage());
